    ...
    <div className="min-h-screen bg-background text-text-primary font-sans overflow-x-hidden selection:bg-[#f3e4bd] selection:text-text-secondary">
              ...
              <div className="lg:col-span-5 relative perspective-1000">
                ...
                <div ref={floatBadge1Ref} className="absolute -top-6 -left-6 z-20 bg-surface border border-border-theme p-4 rounded-2xl shadow-xl flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-text-muted"> 0,000 Grant Awarded</p>
                  </div>
                </div>
          ...
          <div className="md:col-span-2 space-y-3 text-left">
            ...
            <ul className="space-y-2 text-xs text-[#fcf9f2]/75">
              {['Hackathons & Grants', 'SDE Internships', 'Scholarships 2026', 'Freshers Tech Jobs', 'Fellowships'].map(item => (
                <li key={item}>
                  <button onClick={openLoginModal} className="hover:text-[#b5c37c] transition-colors bg-transparent border-none p-0 cursor-pointer text-left">
                    {item}
                  </button>
                </li>
              ))}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-[#231f20]/75 backdrop-blur-md z-[60] flex items-center justify-center p-4">
          <div className="bg-background rounded-3xl w-full max-w-md shadow-2xl p-8 border border-border-theme relative space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <h3 className="text-2xl font-serif font-bold text-text-primary">Welcome to YuvaHub</h3>
            ...
            <p className="text-[11px] text-text-secondary text-center leading-relaxed">
              ...
              <button onClick={() => { closeLoginModal(); setActiveTab('terms'); }} className="text-primary-blue hover:underline bg-transparent border-none p-0 font-bold">Terms</button>
              {' '}and{' '}
              <button onClick={() => { closeLoginModal(); setActiveTab('privacy'); }} className="text-primary-blue hover:underline bg-transparent border-none p-0 font-bold">Privacy Policy</button>.
            </p>
