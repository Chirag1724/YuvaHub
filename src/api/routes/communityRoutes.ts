...
router.post(["/community/posts", "/posts"], authMiddleware, rewardPoints("create_post"), createPost);
...
router.post(["/community/posts/:postId/comments", "/posts/:postId/comments"], authMiddleware, rewardPoints("reply_forum"), createComment);
