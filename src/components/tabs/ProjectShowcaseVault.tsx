...
export default function ProjectShowcaseVault() {
  ...
  return (
    <div className="font-sans h-full">
      ...
      {/* Hero Banner */}
      <div className="border-b border-border-theme dark:border-border-theme bg-surface dark:bg-surface px-4 sm:px-8 py-8">
        <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-surface-secondary dark:bg-surface-secondary text-primary-blue border border-border-theme dark:border-border-theme">
                Open Source Showcase
              </span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-text-primary dark:text-text-primary tracking-tight">
              Project Vault
            </h1>
            <p className="text-xs sm:text-sm text-text-muted dark:text-text-muted max-w-2xl">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-5 py-2.5 bg-[#231f20] hover:bg-primary-blue text-text-primary text-xs sm:text-sm font-bold rounded-xl transition-all shadow-sm hover:shadow-md"
            >
