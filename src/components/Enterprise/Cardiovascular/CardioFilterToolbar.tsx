...
export const CardioFilterToolbar: React.FC<CardioFilterToolbarProps> = ({
  ...
  return (
    <div className="bg-primary-blue border border-border-theme rounded-2xl p-4 shadow-xl mb-6 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
      {/* Left: Search Input */}
      <div className="relative flex-1 min-w-[240px]">
        ...
        <input
          ...
          className="w-full bg-slate-950 border border-border-theme rounded-xl pl-10 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 font-mono"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <select
          ...
          className="bg-slate-950 border border-border-theme rounded-xl px-3 py-2 text-xs text-slate-300 focus:outline-none focus:border-cyan-500 font-mono"
        >
      ...
      <div className="flex items-center justify-between md:justify-end gap-3 pt-2 md:pt-0 border-t md:border-t-0 border-border-theme">
        <span className="text-xs text-text-muted font-mono">
          Showing: <strong className="text-white">{totalFilteredCount}</strong> / {totalCount} Pts
        </span>

        <div className="flex items-center bg-slate-950 border border-border-theme rounded-xl p-1">
          <button
