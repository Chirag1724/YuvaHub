...
export const CardioHemodynamicCalculatorModal: React.FC<CardioHemodynamicCalculatorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-primary-blue border border-border-theme rounded-3xl w-full max-w-5xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border-theme bg-slate-950/80">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/200/20 border border-cyan-500/40 flex items-center justify-center text-cyan-400">
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 overflow-y-auto max-h-[80vh]">
          ...
          <div className="lg:col-span-7 space-y-4">
            {/* Demographics */}
            <div className="bg-slate-950/70 border border-border-theme rounded-2xl p-4 space-y-3 font-mono text-xs">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-text-muted block mb-1">Height (cm)</label>
                  <input
                    type="number"
                    value={heightCm}
                    onChange={(e) => setHeightCm(Number(e.target.value))}
                    className="w-full bg-primary-blue border border-border-theme rounded-xl px-2.5 py-1.5 text-white"
                  />
                </div>
                <div>
                  <label className="text-text-muted block mb-1">Weight (kg)</label>
                  <input
                    type="number"
                    value={weightKg}
                ...
                <div>
                  <label className="text-text-muted block mb-1">Calculated BSA</label>
                  <div className="bg-primary-blue/80 border border-border-theme rounded-xl px-2.5 py-1.5 text-cyan-300 font-bold">
                    {bsa} m²
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-950/70 border border-border-theme rounded-2xl p-4 space-y-3 font-mono text-xs">
              ...
              <div className="grid grid-cols-4 gap-2.5">
                <div>
                  <label className="text-text-muted block mb-1">SBP</label>
                  <input
                    type="number"
                    value={sbp}
                    onChange={(e) => setSbp(Number(e.target.value))}
                    className="w-full bg-primary-blue border border-border-theme rounded-xl px-2 py-1.5 text-white"
                  />
                </div>
                <div>
                  <label className="text-text-muted block mb-1">DBP</label>
                  <input
                    type="number"
                    value={dbp}
                ...
                <div>
                  <label className="text-text-muted block mb-1">HR</label>
                  <input
                    type="number"
                    value={hr}
                ...
                <div>
                  <label className="text-text-muted block mb-1">CO (L/min)</label>
                  <input
                    type="number"
                    step="0.1"
                    value={co}
              ...
              <div className="grid grid-cols-4 gap-2.5">
                <div>
                  <label className="text-text-muted block mb-1">CVP</label>
                  <input
                    type="number"
                    value={cvp}
                ...
                <div>
                  <label className="text-text-muted block mb-1">PAS</label>
                  <input
                    type="number"
                    value={pas}
                ...
                <div>
                  <label className="text-text-muted block mb-1">PAD</label>
                  <input
                    type="number"
                    value={pad}
                ...
                <div>
                  <label className="text-text-muted block mb-1">PCWP</label>
                  <input
                    type="number"
                    value={pcwp}
            ...
            <div className="bg-slate-950/70 border border-border-theme rounded-2xl p-4 space-y-3 font-mono text-xs">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Epi</label>
                  <input
                    type="number"
                    step="0.01"
                    value={epi}
                    onChange={(e) => setEpi(Number(e.target.value))}
                    className="w-full bg-primary-blue border border-border-theme rounded-lg px-2 py-1 text-white"
                  />
                </div>
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Norepi</label>
                  <input
                    type="number"
                    step="0.01"
                    value={norepi}
                ...
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Vaso</label>
                  <input
                    type="number"
                    step="0.01"
                    value={vaso}
                ...
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Dobut</label>
                  <input
                    type="number"
                    step="0.5"
                    value={dobut}
                ...
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Milr</label>
                  <input
                    type="number"
                    step="0.05"
                    value={milr}
                ...
                <div>
                  <label className="text-text-muted block mb-1 text-[10px]">Dopa</label>
                  <input
                    type="number"
                    step="1"
                    value={dopa}
            ...
            <div className="bg-slate-950/70 border border-border-theme rounded-2xl p-4 space-y-3 font-mono text-xs">
              ...
              <div className="grid grid-cols-4 gap-2.5">
                <div>
                  <label className="text-text-muted block mb-1">P1 Pre-Mem</label>
                  <input
                    type="number"
                    value={p1Pre}
                ...
                <div>
                  <label className="text-text-muted block mb-1">P2 Post-Mem</label>
                  <input
                    type="number"
                    value={p2Post}
                ...
                <div>
                  <label className="text-text-muted block mb-1">Rt Radial SpO2</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-text-muted block mb-1">Lower Leg SpO2</label>
                  <input
                    type="number"
                    value={lowerSpO2}
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-slate-950 border border-border-theme rounded-2xl p-5 space-y-4 font-mono">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center justify-between border-b border-border-theme pb-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-primary-blue/90 p-3 rounded-xl border border-border-theme">
                  <span className="text-[10px] text-text-muted block">CARDIAC POWER (CPO)</span>
                  <span className={`text-xl font-black ${cpo < 0.6 ? "text-red-400 animate-pulse" : "text-emerald-400"}`}>
                    {cpo} Watts
                  </span>
                  <span className="text-[10px] text-text-muted block">Target &gt; 0.60 W</span>
                </div>

                <div className="bg-primary-blue/90 p-3 rounded-xl border border-border-theme">
                  <span className="text-[10px] text-text-muted block">RV PAPi INDEX</span>
                  <span className={`text-xl font-black ${papi < 0.9 ? "text-amber-400" : "text-cyan-300"}`}>
                    {papi}
                  </span>
                  <span className="text-[10px] text-text-muted block">Normal &gt; 1.0</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div className="bg-primary-blue/90 p-3 rounded-xl border border-border-theme">
                  <span className="text-[10px] text-text-muted block">SYSTEMIC VASC RES (SVR)</span>
                  <span className="text-lg font-black text-white">{svr}</span>
                  <span className="text-[10px] text-text-muted block">dynes·s/cm⁵ (SVRI: {svri})</span>
                </div>

                <div className="bg-primary-blue/90 p-3 rounded-xl border border-border-theme">
                  <span className="text-[10px] text-text-muted block">PULMONARY VASC (PVR)</span>
                  <span className="text-lg font-black text-white">{pvr} WU</span>
                  <span className="text-[10px] text-text-muted block">Wood Units (PVRI: {pvri})</span>
                </div>
              </div>
              ...
              <div className="space-y-2 text-xs pt-2 border-t border-slate-900">
                <div className="flex justify-between py-1 border-b border-slate-900">
                  <span className="text-text-muted">Mean Arterial Pressure (MAP):</span>
                ...
                <div className="flex justify-between py-1 border-b border-slate-900">
                  <span className="text-text-muted">Transpulmonary Gradient (TPG):</span>
                  <span className="font-bold text-white">{tpg} mmHg</span>
                </div>
                <div className="flex justify-between py-1 border-b border-slate-900">
                  <span className="text-text-muted">Vasoactive-Inotropic Score (VIS):</span>
                  <span className="font-bold text-violet-300">{vis}</span>
                </div>
                <div className="flex justify-between py-1 border-b border-slate-900">
                  <span className="text-text-muted">ECMO TMP ΔP (Clotting Gradient):</span>
                  <span className={`font-black ${tmp >= 50 ? "text-amber-400" : "text-emerald-400"}`}>
                    {tmp} mmHg
                  </span>
                </div>
                <div className="flex justify-between py-1">
                  <span className="text-text-muted">Harlequin Differential Δ SpO2:</span>
        ...
        {/* Footer */}
        <div className="flex items-center justify-end px-6 py-4 border-t border-border-theme bg-slate-950/80">
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-xl text-xs font-bold bg-cyan-600 hover:bg-cyan-500/200 text-white transition-all shadow-md shadow-cyan-600/30"
          >
            Close Calculator
          </button>
        </div>
